export declare const SUPPORTED_SCHEMA_VERSION = "dynamic_workflow/run/v1";
...
export type WorkflowState = "draft" | "validated" | "running" | "completed" | "failed" | "waiting_user" | "cancelled" | "partial_succeeded";
export type StepState = "queued" | "running" | "succeeded" | "failed" | "blocked" | "skipped" | "waiting_user";
